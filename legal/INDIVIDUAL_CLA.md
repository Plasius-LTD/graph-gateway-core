...
**Project:** @plasius/graph-gateway-core (Plasius LTD)  
...
- **"Project"** means the @plasius/graph-gateway-core repositories and related materials owned or managed by **Plasius LTD**.
